...
This Terraform primitive module wraps the `aws_route53_vpc_association_authorization` resource. It authorizes a VPC in a different AWS account to be associated with a local Route53 private hosted zone.
...
|------|-------------|------|---------|:--------:|
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | The VPC to authorize for association with the private hosted zone. | `string` | n/a | yes |
...
| <a name="input_zone_id"></a> [zone\_id](#input\_zone\_id) | The ID of the private hosted zone that is authorizing the VPC association. | `string` | n/a | yes |
